...
/*
  A room model has four main attributes: 
	  room_name (string), 
	  room_DJ (string),
	  room_playlist (string),
	  room_suggestion_list (List of objects)
	  	Each suggestion object consists of:
			track_id (string),
			track_name (string),
			track_artist (string),
 ...
 * the client side
 */
exports.roomsCollection = "room_collection";
